...
VALUES (assets_seq.nextval,
'Receptos Inc',
(SELECT id FROM companies WHERE name='Receptos Inc')
)
;
...
VALUES (funds_portfolio_seq.nextval,
(SELECT id FROM funds WHERE name='perspectivefund'),
(SELECT id FROM assets WHERE asset_name='Receptos Inc'),
154302,
811900,
to_date(30062015, 'ddmmyyyy')
)
...
MERGE INTO companies c
USING ( SELECT 1 FROM dual ) d
ON ( c.name = 'BHP Billiton Ltd (ADR)' )
WHEN NOT MATCHED THEN
INSERT (id,
name
)
...
MERGE INTO assets a
USING ( SELECT 1 FROM dual ) d
ON ( a.asset_name = 'BHP Billiton Ltd (ADR)' )
WHEN NOT MATCHED THEN
INSERT (id,
asset_name,
company_id
...
VALUES (assets_seq.nextval,
'BHP Billiton Ltd (ADR)',
(SELECT id FROM companies WHERE name='BHP Billiton Ltd (ADR)')
)
;
...
VALUES (funds_portfolio_seq.nextval,
(SELECT id FROM funds WHERE name='perspectivefund'),
(SELECT id FROM assets WHERE asset_name='BHP Billiton Ltd (ADR)'),
40710,
1000000,
to_date(30062015, 'ddmmyyyy')
)
...
VALUES (assets_seq.nextval,
'South Ltd (ADR)',
(SELECT id FROM companies WHERE name='South Ltd (ADR)')
)
;
...
VALUES (funds_portfolio_seq.nextval,
(SELECT id FROM funds WHERE name='perspectivefund'),
(SELECT id FROM assets WHERE asset_name='South Ltd (ADR)'),
2203,
328320,
to_date(30062015, 'ddmmyyyy')
)
