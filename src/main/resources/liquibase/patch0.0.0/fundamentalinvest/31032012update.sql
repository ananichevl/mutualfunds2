...
-- changeset mkp:add-records-31032012-01
...
-- changeset mkp:add-records-31032012-02
...
MERGE INTO companies c
USING ( SELECT 1 FROM dual ) d
ON ( c.name = 'Microchip Technology Inc' )
WHEN NOT MATCHED THEN
INSERT (id,
name
)
...
MERGE INTO assets a
USING ( SELECT 1 FROM dual ) d
ON ( a.asset_name = 'Microchip Technology Inc' )
WHEN NOT MATCHED THEN
INSERT (id,
asset_name,
company_id
...
VALUES (assets_seq.nextval,
'Microchip Technology Inc',
(SELECT id FROM companies WHERE name='Microchip Technology Inc')
)
;
...
VALUES (funds_portfolio_seq.nextval,
(SELECT id FROM funds WHERE name='fundamentalinvest'),
(SELECT id FROM assets WHERE asset_name='Microchip Technology Inc'),
93000,
2500000,
to_date(31032012, 'ddmmyyyy')
)
...
MERGE INTO companies c
USING ( SELECT 1 FROM dual ) d
ON ( c.name = 'Focus Media Holding Ltd (ADR)' )
WHEN NOT MATCHED THEN
INSERT (id,
name
)
...
MERGE INTO assets a
USING ( SELECT 1 FROM dual ) d
ON ( a.asset_name = 'Focus Media Holding Ltd (ADR)' )
WHEN NOT MATCHED THEN
INSERT (id,
asset_name,
company_id
...
VALUES (assets_seq.nextval,
'Focus Media Holding Ltd (ADR)',
(SELECT id FROM companies WHERE name='Focus Media Holding Ltd (ADR)')
)
;
...
VALUES (funds_portfolio_seq.nextval,
(SELECT id FROM funds WHERE name='fundamentalinvest'),
(SELECT id FROM assets WHERE asset_name='Focus Media Holding Ltd (ADR)'),
100480,
4000000,
to_date(31032012, 'ddmmyyyy')
)
...
MERGE INTO assets a
USING ( SELECT 1 FROM dual ) d
ON ( a.asset_name = 'J C Penney Co Inc' )
WHEN NOT MATCHED THEN
INSERT (id,
asset_name,
company_id
...
VALUES (assets_seq.nextval,
'J C Penney Co Inc',
(SELECT id FROM companies WHERE name='J C Penney Co Inc')
)
;
...
VALUES (funds_portfolio_seq.nextval,
(SELECT id FROM funds WHERE name='fundamentalinvest'),
(SELECT id FROM assets WHERE asset_name='J C Penney Co Inc'),
21612,
610000,
to_date(31032012, 'ddmmyyyy')
)
...
MERGE INTO assets a
USING ( SELECT 1 FROM dual ) d
ON ( a.asset_name = 'Dun & Bradstreet Corp' )
WHEN NOT MATCHED THEN
INSERT (id,
asset_name,
company_id
...
VALUES (assets_seq.nextval,
'Dun & Bradstreet Corp',
(SELECT id FROM companies WHERE name='Dun & Bradstreet Corp')
)
;
...
VALUES (funds_portfolio_seq.nextval,
(SELECT id FROM funds WHERE name='fundamentalinvest'),
(SELECT id FROM assets WHERE asset_name='Dun & Bradstreet Corp'),
4171,
49228,
to_date(31032012, 'ddmmyyyy')
)
...
MERGE INTO companies c
USING ( SELECT 1 FROM dual ) d
ON ( c.name = 'Newfield Exploration Co' )
WHEN NOT MATCHED THEN
INSERT (id,
name
)
...
MERGE INTO assets a
USING ( SELECT 1 FROM dual ) d
ON ( a.asset_name = 'Newfield Exploration Co' )
WHEN NOT MATCHED THEN
INSERT (id,
asset_name,
company_id
...
VALUES (assets_seq.nextval,
'Newfield Exploration Co',
(SELECT id FROM companies WHERE name='Newfield Exploration Co')
)
;
...
VALUES (funds_portfolio_seq.nextval,
(SELECT id FROM funds WHERE name='fundamentalinvest'),
(SELECT id FROM assets WHERE asset_name='Newfield Exploration Co'),
22716,
655027,
to_date(31032012, 'ddmmyyyy')
)
...
VALUES (assets_seq.nextval,
'Aon Corp',
(SELECT id FROM companies WHERE name='Aon Corp')
)
;
...
VALUES (funds_portfolio_seq.nextval,
(SELECT id FROM funds WHERE name='fundamentalinvest'),
(SELECT id FROM assets WHERE asset_name='Aon Corp'),
164842,
3360000,
to_date(31032012, 'ddmmyyyy')
)
...
MERGE INTO companies c
USING ( SELECT 1 FROM dual ) d
ON ( c.name = 'Travelers Companies Inc' )
WHEN NOT MATCHED THEN
INSERT (id,
name
)
...
MERGE INTO assets a
USING ( SELECT 1 FROM dual ) d
ON ( a.asset_name = 'Travelers Companies Inc' )
WHEN NOT MATCHED THEN
INSERT (id,
asset_name,
company_id
...
VALUES (assets_seq.nextval,
'Travelers Companies Inc',
(SELECT id FROM companies WHERE name='Travelers Companies Inc')
)
;
...
VALUES (funds_portfolio_seq.nextval,
(SELECT id FROM funds WHERE name='fundamentalinvest'),
(SELECT id FROM assets WHERE asset_name='Travelers Companies Inc'),
88800,
1500000,
to_date(31032012, 'ddmmyyyy')
)
...
VALUES (assets_seq.nextval,
'C&C Group PLC',
(SELECT id FROM companies WHERE name='C&C Group PLC')
)
;
...
VALUES (funds_portfolio_seq.nextval,
(SELECT id FROM funds WHERE name='fundamentalinvest'),
(SELECT id FROM assets WHERE asset_name='C&C Group PLC'),
46067,
8948312,
to_date(31032012, 'ddmmyyyy')
)
...
VALUES (assets_seq.nextval,
'NV Energy Inc',
(SELECT id FROM companies WHERE name='NV Energy Inc')
)
;
...
VALUES (funds_portfolio_seq.nextval,
(SELECT id FROM funds WHERE name='fundamentalinvest'),
(SELECT id FROM assets WHERE asset_name='NV Energy Inc'),
112840,
7000000,
to_date(31032012, 'ddmmyyyy')
)
